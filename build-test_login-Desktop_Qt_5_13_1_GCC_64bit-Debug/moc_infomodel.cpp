...
#include <memory>
#include "../test_login/infomodel.h"
...
QT_MOC_LITERAL(1, 10, 13), // "InfoIsChecked"
QT_MOC_LITERAL(2, 24, 0) // ""

    },
    "InfoModel\0InfoIsChecked\0"
};
...
void InfoModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&InfoModel::InfoIsChecked)) {
                *result = 0;
                return;
            }
        }
